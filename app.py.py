...
/* Readable text on every light surface */
...
section[data-testid="stSidebar"] {
    ...
    border-right: 1px solid #BFDCC9 !important;
}
...
/* Hero */
.hero {
    background: linear-gradient(135deg, #DDF3E5 0%, #FFFFFF 82%);
    border: 1px solid #C7E2D0;
    border-radius: 24px;
    padding: 32px 36px;
    margin-bottom: 24px;
    box-shadow: 0 8px 28px rgba(18, 55, 42, 0.07);
}
...
.card {
    ...
    padding: 22px;
    margin: 10px 0;
    box-shadow: 0 6px 20px rgba(18, 55, 42, 0.055);
}
...
/* White dropdown field */
div[data-baseweb="select"] > div {
    background: #FFFFFF !important;
    color: #17211B !important;
    border: 1.5px solid #D8E5DE !important;
    border-radius: 12px !important;
...
div[data-baseweb="select"] svg {
    fill: #17211B !important;
    color: #17211B !important;
}

div[data-baseweb="select"] > div:hover,
div[data-baseweb="select"] > div:focus-within {
    border-color: #20A36A !important;
    box-shadow: 0 0 0 2px rgba(32, 163, 106, 0.12) !important;
}

/* White dropdown menu with black options */
div[role="listbox"] {
    background: #FFFFFF !important;
    border: 1px solid #D8E5DE !important;
    border-radius: 12px !important;
    box-shadow: 0 10px 30px rgba(18, 55, 42, 0.14) !important;
}
...
div[role="option"]:hover p,
div[role="option"][aria-selected="true"] span,
div[role="option"][aria-selected="true"] p {
    color: #17211B !important;
}
...
button[data-baseweb="tab"][aria-selected="true"] {
    color: #178654 !important;
    border-bottom-color: #20A36A !important;
}
...
DATA_PATH = Path(__file__).resolve().parent / "data" / "air_quality.csv"
